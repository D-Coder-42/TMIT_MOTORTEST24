...
#define TARGET_ADC_FREQ 2000

// Define SD Card Write Frequency (Hz)
#define TARGET_SD_WRITE_FREQ 2
...
#define ADC_PARALLEL_CHANNELS 2
...
void setup()
{
  ...
  pinMode(DAQ_FINISH_PIN, INPUT_PULLDOWN); // Setup Digital Pin for Signal Logging Finish
